        ...
        <div className="absolute inset-0">
          {isLoaded ? (
            <GoogleMap
              ...
              center={currentLocation || { lat: -6.2, lng: 106.816666 }}
              zoom={15}
              onLoad={onMapLoad}
              options={mapOptions}
              ...
              {nearestRestaurants.map((restaurant, index) => (
                <React.Fragment key={index}>
                  <Marker
                    ...
                    onClick={() => {
                      void router.push(`/destination/${restaurant.id}`);
                    }}
          ...
          <Drawer.Portal>
            ...
            <Drawer.Content className="bg-white flex flex-col rounded-t-[10px] h-[96%] mt-24 fixed bottom-0 left-0 right-0 w-full max-w-md mx-auto text-black">
              <div className="p-6 flex-1 overflow-y-auto pb-24">
                ...
                <h2 className="text-xl font-semibold mb-6 text-center mt-6">
                  Discovery
                </h2>
                ...
                <div className="relative mb-4">
                  <input
                    ...
                    onKeyDown={(e) => {
                      if (e.key === "Enter") {
                        ...
                        executeRAGrequest(e.currentTarget.value).then(
                          (response) => {
                            setMessages((prevMessages) => [
                              ...prevMessages,
                              {
                                text: response.text,
                                isUser: false,
                                restaurants: response.destinationCited.map(
                                  (destination) => ({
                  ...
                  />
                  <svg
                    className="w-6 h-6 text-gray-400 absolute right-3 top-2"
